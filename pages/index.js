    ...
    <div className="container" style={{ fontFamily: 'Arial', padding: '2rem' }}>
      ...
      <main style={{ fontSize: '1.2rem', fontWeight: 'bold', textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <ul>
          ...
          <li>Couleur + shampooing : 48,50 €</li>
          <li>Shampooing coiffage : 16 €</li>
        </ul>
